// Node Server 入口：提供三种协议的聊天/模型接口 + 日志接口
// 前端通过 Vite 代理把 /api 请求转发到这里（端口 3001）

import express from 'express'
import { chatWithProtocol, listModels, type ChatRequest, type ChatResult, type Protocol } from './src/server/clients'
import { LogManager } from './src/server/logger'
import type { LogEvent } from './src/server/middleware'
